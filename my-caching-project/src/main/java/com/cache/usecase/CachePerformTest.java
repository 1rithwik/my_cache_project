...
public class CachePerformTest {
    public static void main(String[] args) throws Exception {
        testPerformance(1_000, 100); // 10,000 products, 1,000 cache size
        testPerformance(100_000, 10_000); // 1 million products, 100,000 cache size
    }
