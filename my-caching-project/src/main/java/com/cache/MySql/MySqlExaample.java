...
public class MySqlExaample {
    ...
    private static void createRecord() {
        String query = "INSERT INTO Employee (EmployeeID, name, email, phone,JobTitle, salary,Department) VALUES (?, ?, ?, ?, ?,?,?)";
        try {
    ...
    private static void updateRecord() {
        String query = "UPDATE employee SET salary = ? WHERE EmployeeID = ?";
        try {
            preparedStatement = connection.prepareStatement(query);
